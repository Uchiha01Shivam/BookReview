...
namespace BookReviewWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.SpecialKey == "Shivam") // Replace "YourSecretKey" with your actual secret key
                {
                ...
                else if(string.IsNullOrEmpty(Input.SpecialKey))
                {
                    ...
                    {
                        _logger.LogInformation("User created a new account with password.");
                        await _userManager.AddToRoleAsync(user, "User"); // Assign the default role "User"
